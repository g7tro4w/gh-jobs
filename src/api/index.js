...
export default {
  positions: {
    ...
    * @property {String} [lat] - A specific latitude. If you use this, don't send location.
    * @property {String} [long] - A specific longitude. If you use this, don't send location.
    ...
    */
    ...
    /**
    * Gets information about single job position.
    *
